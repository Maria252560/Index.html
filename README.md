...
<head>
    ...
    <title>MYAH Atelier | Original Jewelry</title>
    ...
    <style>
        ...
        * {
        ...
        .panel-side .gallery-item {
            aspect-ratio: 3/4;
        }

        .panel-center .gallery-item {
            aspect-ratio: 4/3;
        }
        ...
        @media (max-width: 768px) {
            ...
            .art-panel { flex-direction: column; gap: 1.5rem; }
